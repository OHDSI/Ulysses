...
* toolType: specifies the type of tool being used for the study. Options are `"dbms"` (default) for studies that execute directly against a database, or `"external"` for studies using external analytical tools or pre-computed data. This determines which main.R template is used to initialize the execution pipeline.
